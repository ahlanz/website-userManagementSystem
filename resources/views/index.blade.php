                ...
                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                    <div class="p-3 rounded-full bg-orange-400 bg-opacity-75">
                        <svg class="h-8 w-8 text-white" viewBox="0 0 24 24" fill="none"
                            ...
                            <path d="M3 3H5L6 14H18L19 6H6" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <div class="mx-5">
                        <h4 class="text-2xl font-semibold text-gray-700">{{ $products->count() }}</h4>
                        <div class="text-gray-500">New Product</div>
                    </div>
                </div>
            </div>
        </div>
